...
async def generate_cover(
    ...
    try:
        ...
        await send(
            text="[ERROR]: FAILED TO EDIT VC TITLE, MAKE ME ADMIN WITH VC & DELETE MESSAGE RIGHTS."
        )
        pass
    return final
...
async def telegram(message):
    ...
    m = await message.reply_text("__**Downloading Wait.**__")
